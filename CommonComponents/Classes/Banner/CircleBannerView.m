...
- (UIPageControl *)pageControl
{
    if (!_pageControl) {
        ...
        _pageControl.pageIndicatorTintColor = ColorWithHex(@"#959495");
        _pageControl.currentPageIndicatorTintColor = ColorWithHex(@"#D67118");
...
- (UILabel *)pageLabel
{
    if (_pageLabel == nil) {
        ...
        _pageLabel.layer.borderColor = ColorWithHex(@"#333333").CGColor;
        _pageLabel.textColor = ColorWithHex(@"#333333");
